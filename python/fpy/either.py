...
from monad import _Monad
from natural_transform import NTrans, _NTrans
from abc import ABCMeta, abstractmethod, abstractclassmethod
import collections.abc as cabc
from dataclasses import dataclass
from typing import TypeVar, Generic, Callable, List, Tuple, Union
...
class Left(Either[L, R]):
  ...
  def __ntrans__(self, t: _NTrans[Either, Union[L, R], G, T]) -> G[T]:
    return t(self.v)
